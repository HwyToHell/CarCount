...
int usb_main(int argc, char* argv[])
{
	...
	//cv::VideoCapture cap("D:/Holger/AppDev/OpenCV/BGS_old/Debug/dataset/640x480_20fps/_Multi_640x480_20fps.avi");
	cv::VideoCapture cap("D:/Holger/AppDev/OpenCV/BGS_old/Debug/dataset/320x240_20fps/_4min_320x240_20fps.avi");
	if (!cap.isOpened())
	{
	...
	*/
	...
	while(true)
	{
		...
		newBlobsVibe = FindShapes(bgrVibe, frame);
